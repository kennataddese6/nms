        ...
        <Sheet open={isDrawerOpen} onOpenChange={setIsDrawerOpen}>
          ...
          <SheetContent className="sm:max-w-md rounded-l-3xl">
            <SheetHeader className="pb-4 border-b">
              ...
              <SheetDescription>
                Create a new room listing in Bubbly Day Nursery.
              </SheetDescription>
            </SheetHeader>
          ...
          <CardHeader className="border-b p-6 flex flex-row justify-between items-center bg-neutral-50/50">
            <div>
              ...
              <CardDescription className="text-xs">
                Active student enrollment list.
              </CardDescription>
            </div>
                  ...
                  <tbody className="divide-y text-xs">
                    {activeRoom.children.map((child) => (
                      <tr key={child.id} className="hover:bg-neutral-50/50 transition-colors">
                        ...
                        <td className="p-3">
                          {child.allergies ? (
                            <Badge variant="outline" className="bg-red-50 text-destructive border-red-200 font-bold flex items-center gap-1 w-max">
